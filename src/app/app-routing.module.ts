...
import { PantallaBitacoraTransaccionesComponent } from './PANTALLAS_ADMIN/pantalla-bitacora-transacciones/pantalla-bitacora-transacciones.component';
...
const routes: Routes = [
  ...
  // RUTAS ADMINISTRADOR  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    {
      path: 'pantalla-bitacora-transacciones', 
      component: PantallaBitacoraTransaccionesComponent, 
      canActivate: [AuthGuard], 
      data: { role: 'Admin' } 
    },
    {
